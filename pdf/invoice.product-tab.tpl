 ...
 {foreach $order_details as $order_detail}
   ...
   <tr class="product {$bgcolor_class}">
     ...
     <td class="product right">
       {if $order_detail.decimal_quantity}
         {displayPrice currency=$order->id_currency price=$order_detail.unit_price_tax_excl_including_ecotax / ($order_detail.decimal_quantity / $order_detail.product_quantity)} {$order_detail.unity}
       {else}
     ...
     <td class="product center">
       {$order_detail.decimal_quantity} {$order_detail.unit}
     </td>
     <td  class="product right">
